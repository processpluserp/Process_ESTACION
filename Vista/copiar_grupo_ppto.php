				...
				$nueva_estructura_grupos.= "<tr class = '$id informacion_guardada_bd item_total$i items_ppto_pro'>
									...
									<td class = 'border_table' align = 'center' style = 'background-color:#EF8B8B;color:white;' nowrap>
										<table width = '100%'>
											<tr>
												<td>$</td>
												<td align = 'right'><input type = 'text' style = 'width:80px;' class = 'entrada_bordes valorunitariocliente$id' onblur = 'limpiar_valor_costo_cliente($i);' value = '".number_format($row['cliente'])."' id = 'valor_costo_unitario_cliente$i' onkeyup = 'formatear_valor_costo_cliente($i);calcular_interno($i);'/></td>
											</tr>
										</table>
